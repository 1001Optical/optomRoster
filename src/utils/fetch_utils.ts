...
const refresh = async (start?: Date, end?: Date, selectOption?: number | string) => {
    ...
    try {
        ...
        const response = await fetch(`/api/roster/roster/refresh?manual=true&scheduler=true&from=${fromDate}&to=${toDate}${extraParams}`, {
            method: "GET",
        });
...
const refreshManual = async () => {
    ...
    try {
        ...
        const response = await fetch(`/api/roster/roster/refresh?from=${fromDate}&to=${toDate}`, {
            method: "GET",
        });
...
const getList = async (start?: Date, end?: Date, selectOption?: number | string) => {
    ...
    try {
        ...
        const res = await fetch(`/api/roster/roster/getList?from=${fromDate}&to=${toDate}${extraParams}`, {
            method: "GET",
        });
...
const getOptomCount = async (date: string): Promise<OptomCountResult[]> => {
    ...
    try {
        ...
        const res = await fetch(`/api/roster/roster/optom-count?date=${dateOnly}`, {
            method: "GET",
        });
...
const getOptomCountByRange = async (from: string, to: string, weekly: boolean = false): Promise<OptomCountResult[] | { data: OptomCountResult[]; dates: string[] }> => {
    ...
    try {
        ...
        const res = await fetch(`/api/roster/roster/optom-count?from=${fromDate}&to=${toDate}${weeklyParam}`, {
            method: "GET",
        });
